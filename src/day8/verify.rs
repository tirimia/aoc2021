...
gcafb gcf dcaebfg ecagb gf abcdeg gaef cafbge fdbac fegbdc | fgae cfgab fg bagce";
    ...
    const RAW_INPUT: &str = r"ceb bgfdea febgc ec eadcgfb eagbcd fcdebg dcef gafbc egdbf | fdbgec fedbg gdabefc gefbd
...
bea gebfd edfbacg egcdfa ab dagec dgeba dcab abcdge cgeabf | acdbge ba gecafd dfbge";
    ...
    #[test]
    fn day8a_example() {
        assert_eq!(day8a(input_to_readings(RAW_TEST_INPUT)), 26)
    }
